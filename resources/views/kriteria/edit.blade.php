                    ...
                    <form action="/kriteria/{{$kriteria->id}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="pengguna" id="pengguna">
                                ...
                                <option value="Mahasiswa" @php if($kriteria->pengguna == 'Mahasiswa') { echo
                                    "selected=''"; } @endphp>Mahasiswa</option>
                                <option value="Admin" @php if($kriteria->pengguna == 'Admin') { echo "selected=''"; }
                                    @endphp>Admin</option>
                            </select>
                        </div>
