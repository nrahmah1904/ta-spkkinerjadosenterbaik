                ...
                <div class="form-group">
                    <form action="/matkul/store" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="form1" type="text" class="form-control" name="kode" value="{{$matkul->kode}}">
                        </div>
                        <div class="form-group">
                            <label>Nama Mata Kuliah</label>
                            <input id="form1" type="text" class="form-control" name="nama"
                                placeholder="Masukkan Nama Mata Kuliah" value="{{$matkul->nama}}">
                        </div>
                        <div class="form-group">
                            <label>Jumlah SKS</label>
                            <input id="form1" type="text" class="form-control" name="sks"
                                placeholder="Masukkan Jumlah SKS" value="{{$matkul->sks}}">
                        </div>
                        <div class="form-group">
                            <label>Semester</label>
                            <input id="form1" type="text" class="form-control" name="smt"
                                placeholder="Masukkan Semester" value="{{$matkul->smt}}">
                        </div>
