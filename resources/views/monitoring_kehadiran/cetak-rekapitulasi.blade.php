...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <h5 class="text-center text-uppercase text-decoration-underline mt-4">LAPORAN MONITORING KEHADIRAN DOSEN</h5>
        <br>
        <p style="text-align:justify;">TAHUN AJARAN : {{ $tahunAjaranAktif->tahun_ajaran }} {{ $tahunAjaranAktif->ganjil_genap }}</p>
        <p style="text-align:justify;">Kategori Pertemuan : {{ str_replace('_', '-', $kategori) }}</p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $perkuliahan->monitoringKehadiran->jumlah_pertemuan ?? '0' }}</td>
                    </tr>
                    @endforeach
                @endforeach
            </tbody>
